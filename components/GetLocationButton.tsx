  ...
  return (
    <div className="flex justify-center mt-4">
      <Button
        ...
        onClick={getCurrentLocation} // You must add () after function so that it is executed if you're doing an arrow function
        disabled={isLoading}
      >
        {isLoading ? (
          <>
          ...
          <>
            <Navigation className="h-4 w-4 mr-2 text-primary group-hover:scale-110 transition-transform" />
